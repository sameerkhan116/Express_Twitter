...
!function (a, b) {
  ...
  var q = "3.2.1 -ajax,-ajax/jsonp,-ajax/load,-ajax/parseXML,-ajax/script,-ajax/var/locatio" +
        "n,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-event/ajax," +
  ...
  r.each(r.expr.match.bool.source.match(/\w+/g), function (a, b) {
    ...
    ab[b] = function (a, b, d) {
      var e,
        f,
        g = b.toLowerCase();
      return d || (f = ab[g], ab[g] = e, e = null != c(a, b, d)
        ? g
        : null, ab[g] = f),
      e
    }
          ...
          : r.isFunction(a)
            ...
            : this.each(function () {
              ...
              if ("string" === c) {
                ...
                void 0 !== a && "boolean" !== c || (b = eb(this), b && W.set(this, "__className__", b), this.setAttribute && this.setAttribute("class", b || a === !1
                  ? ""
      ...
      var g,
        ...
        q = l.call(b, "namespace")
          ? b
            ...
            .split(".")
          : [];
      if (h = i = e = e || d, 3 !== e.nodeType && 8 !== e.nodeType && !gb.test(p + r.event.triggered) && (p.indexOf(".") > -1 && (q = p.split("."), p = q.shift(), q.sort()), k = p.indexOf(":") < 0 && "on" + p, b = b[r.expando]
        ? b
