...
!function (t, e) {
  ...
  var o,
    ...
    P = function (t) {
      ...
      var i = {
        ...
        getSelectorFromElement: function (e) {
          ...
          "#" === i.charAt(0) && (n = i, i = n = "function" == typeof t.escapeSelector
          ...
          for (var s in n) 
            if (Object.prototype.hasOwnProperty.call(n, s)) {
              var r = n[s],
                ...
                a = o && i.isElement(o)
                  ? "element"
                  : (l = o, {}.toString.call(l).match(/\s([a-zA-Z]+)/)[1].toLowerCase());
    ...
    L = (a = "alert", h = "." + (l = "bs.alert"), c = (o = e).fn[a], u = {
      ...
      e._removeElement = function (t) {
        ...
        P.supportsTransitionEnd() && o(t).hasClass(d)
          ? o(t).one(P.TRANSITION_END, function (n) {
    ...
    R = (m = "button", E = "." + (v = "bs.button"), T = ".data-api", y = (p = e).fn[m], C = "active", I = "btn", A = "focus", b = '[data-toggle^="button"]', D = '[data-toggle="buttons"]', S = "input", w = ".active", N = ".btn", O = {
      ...
      return e.toggle = function () {
        ...
        e && this
          ._element
          .setAttribute("aria-pressed", !p(this._element).hasClass(C)),
          ...
          C._slide = function (e, n) {
            ...
            if (e === h
              ...
              P.supportsTransitionEnd() && t(this._element).hasClass(p)
                ? (t(c).addClass(s), P.reflow(c), t(a).addClass(i), t(c).addClass(i), t(a).one(P.TRANSITION_END, function () {
                  t(c)
                    .removeClass(i + " " + s)
                    .addClass(g),
        ...
        m = function () {
          function i(e, n) {
            ...
            for (var i = t(p.DATA_TOGGLE), s = 0; s < i.length; s++) {
              ...
              null !== o && t(o)
                .filter(e)
                .length > 0 && (this._selector = o, this._triggerArray.push(r))
            }
          ...
          o.show = function () {
            ...
            if (!this._isTransitioning && !t(this._element).hasClass(c) && (this._parent && 0 === (e = t.makeArray(t(this._parent).find(p.ACTIVES).filter('[data-parent="' + this._config.parent + '"]'))).length && (e = null), !(e && (s = t(e).not(this._selector).data(n)) && s._isTransitioning))) {
              ...
              if (t(this._element).trigger(o), !o.isDefaultPrevented()) {
                ...
                this._triggerArray.length > 0 && t(this._triggerArray)
                  .removeClass(d)
          ...
          o._getDimension = function () {
            return t(this._element).hasClass(_)
              ? _
              : g
          },
      ...
      var e = "dropdown",
        ...
        L = function () {
            ...
            if (!this._element.disabled && !t(this._element).hasClass(u)) {
              ...
              if (a._clearMenus(), !i) {
                ...
                if (t(e).trigger(r), !r.isDefaultPrevented()) {
                  ...
                  "ontouchstart" in document.documentElement && 0 === t(e)
                    .closest(C)
                    .length && t("body")
                    .children()
          ...
          a._jQueryInterface = function (e) {
            return this.each(function () {
              var n = t(this).data(i);
              if (n || (n = new a(this, "object" == typeof e
                ? e
                : null), t(this).data(i, n)), "string" == typeof e) {
              ...
              for (var n = t.makeArray(t(E)), s = 0; s < n.length; s++) {
                ...
                if (o) {
                  ...
                  if (t(r).hasClass(f) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && t.contains(r, e.target))) {
                    ...
                    t(r).trigger(u),
                    u.isDefaultPrevented() || ("ontouchstart" in document.documentElement && t("body").children().off("mouseover", null, t.noop), n[s].setAttribute("aria-expanded", "false"), t(h).removeClass(f), t(r).removeClass(f).trigger(t.Event(c.HIDDEN, l)))
                  }
                }
              }
            },
          ...
          a._dataApiKeydownHandler = function (e) {
            if ((/input|textarea/i.test(e.target.tagName)
              ...
              : h.test(e.which)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !t(this).hasClass(u))) {
        ...
        p = function () {
          ...
          p.show = function (e) {
            ...
            if (!this._isTransitioning && !this._isShown) {
              ...
              this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), t(document.body).addClass(f), this._setEscapeEvent(), this._setResizeEvent(), t(this._element).on(h.CLICK_DISMISS, g.DATA_DISMISS, function (t) {
                return n.hide(t)
              }), t(this._dialog).on(h.MOUSEDOWN_DISMISS, function () {
                t(n._element)
                  .one(h.MOUSEUP_DISMISS, function (e) {
          ...
          p.hide = function (e) {
            ...
            if (e && e.preventDefault(), !this._isTransitioning && this._isShown) {
              ...
              if (t(this._element).trigger(i), this._isShown && !i.isDefaultPrevented()) {
                ...
                s
                  ? t(this._element).one(P.TRANSITION_END, function (t) {
          ...
          p._enforceFocus = function () {
            ...
            t(document)
              ...
              .on(h.FOCUSIN, function (n) {
                document !== n.target && e._element !== n.target && 0 === t(e._element)
                  .has(n.target)
                  .length && e
                  ._element
                  .focus()
            ...
            if (this._isShown && this._config.backdrop) {
              ...
              if (this._backdrop = document.createElement("div"), this._backdrop.className = u, i && t(this._backdrop).addClass(i), t(this._backdrop).appendTo(document.body), t(this._element).on(h.CLICK_DISMISS, function (t) {
                n._ignoreBackdropClick
                  ...
                  : t.target === t.currentTarget && ("static" === n._config.backdrop
                    ? n._element.focus()
                    : n.hide())
    ...
    U = function (t) {
      var e = "tooltip",
        ...
        u = {
          animation: !0,
          template: '<div class="tooltip" role="tooltip"><div class="arrow"></div><div class="tooltip' +
              '-inner"></div></div>',
          trigger: "hover focus",
          title: "",
          delay: 0,
        ...
        I = function () {
          ...
          I.show = function () {
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              t(r).addClass(p),
              "ontouchstart" in document.documentElement && t("body")
                .children()
                .on("mouseover", null, t.noop);
              var u = function () {
          ...
          I.hide = function (e) {
            var n = this,
              ...
              r = function () {
                n._hoverState !== f && i.parentNode && i
                  .parentNode
                  .removeChild(i),
                n._cleanTipClass(),
                n
            ...
            s.isDefaultPrevented() || (t(i).removeClass(p), "ontouchstart" in document.documentElement && t("body").children().off("mouseover", null, t.noop), this._activeTrigger[y] = !1, this._activeTrigger[T] = !1, this._activeTrigger[E] = !1, P.supportsTransitionEnd() && t(this.tip).hasClass(g)
          ...
          I._enter = function (e, n) {
            ...
            e && (n._activeTrigger["focusin" === e.type
                ? T
                : E] = !0),
            t(n.getTipElement()).hasClass(p) || n._hoverState === f
              ? n._hoverState = f
              : (clearTimeout(n._timeout), n._hoverState = f, n.config.delay && n.config.delay.show
          ...
          I._leave = function (e, n) {
            var i = this.constructor.DATA_KEY;
            (n = n || t(e.currentTarget).data(i)) || (n = new this.constructor(e.currentTarget, this._getDelegateConfig()), t(e.currentTarget).data(i, n)),
            e && (n._activeTrigger["focusout" === e.type
                ? T
                : E] = !1),
            n._isWithActiveTrigger() || (clearTimeout(n._timeout), n._hoverState = d, n.config.delay && n.config.delay.hide
              ? n._timeout = setTimeout(function () {
      ...
      var e = "popover",
        ...
        l = r({}, U.Default, {
          ...
          template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-' +
              'header"></h3><div class="popover-body"></div></div>'
        }),
        ...
        g = function () {
          ...
          g._activate = function (e) {
            ...
            i.hasClass(c)
              ...
              : (i.addClass(u), i.parents(f.NAV_LIST_GROUP).prev(f.NAV_LINKS + ", " + f.LIST_ITEMS).addClass(u), i.parents(f.NAV_LIST_GROUP).prev(f.NAV_ITEMS).children(f.NAV_LINKS).addClass(u)),
  ...
  !function (t) {
    if ("undefined" == typeof t) 
      throw new TypeError("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap" +
          "'s JavaScript.");
    var e = t
      .fn
      .jquery
